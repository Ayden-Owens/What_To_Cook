...
function Contact() {
  ...
  const submitForm = async () => {
    try {
      await fetch('https://whattocookapp-ed9fe9a2a3d4.herokuapp.com/contactus', {
        method: 'POST',
        headers: {
  ...
  return (
    ...
    <form>
        ...
        <textarea id="text" value={text} onChange={(e) => setText(e.target.value)} rows="4" required></textarea>
